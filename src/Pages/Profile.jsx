...
//             <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 p-5 rounded-2xl border border-blue-400/30 shadow-lg hover:scale-105 transition-all text-center">
//               <div className="text-4xl mb-2">🏆</div>
//               <p className="text-white font-bold text-lg">Level 1</p>
//               <p className="text-white/70 text-sm">Achievements</p>
//             </div>
//             <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-5 rounded-2xl border border-pink-400/30 shadow-lg hover:scale-105 transition-all text-center">
//               <div className="text-4xl mb-2">⭐</div>
...
//             <button className="w-full bg-white/10 hover:bg-white/20 border border-white/30 backdrop-blur-sm text-white py-4 px-6 rounded-2xl font-bold text-lg shadow-md transition-all flex items-center justify-center space-x-3">
...
//               className="w-full bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white py-4 px-6 rounded-2xl font-bold text-lg shadow-xl hover:scale-105 transition-all flex items-center justify-center space-x-3"
//             >
